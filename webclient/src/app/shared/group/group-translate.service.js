(function () {
  ...
  angular
    .module('gmm')
    .service('groupTranslateService', groupTranslateService);

  function groupTranslateService($translate) {
    ...
    function translation() {
      ...
      function resolve(translations) {
        ...
        translate['CONFIRM_SAVE_GROUP_ID'] = translations.CONFIRM_SAVE_GROUP_ID;
